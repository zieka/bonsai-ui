...
const stories = storiesOf('Pages/Shadows', module).addDecorator(checkA11y);

stories.add('shadow examples', () => (
  <div>
    ...
    <p>The .shadow--pop class adds a shadow on interaction with the element:</p>
    <div style={{ textAlign: 'center' }}>
      <LazyLoad height={200}>
        <img
